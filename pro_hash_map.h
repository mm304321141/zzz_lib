...
using pro_hash_map = pro_hash<pro_hash_map_config_t<key_t, value_t, std::true_type, hasher_t, key_equal_t, allocator_t>>;
template<class key_t, class value_t, class hasher_t = std::hash<key_t>, class key_equal_t = std::equal_to<key_t>, class allocator_t = std::allocator<std::pair<key_t const, value_t>>>
using pro_hash_multimap = pro_hash<pro_hash_map_config_t<key_t, value_t, std::false_type, hasher_t, key_equal_t, allocator_t>>;